# Підключення через драйвер з MongoDB
...
authors_add = db.authors.insert_many(
[
  {
...
print(authors_add.inserted_ids)
quotes_add = db.quotes.insert_many(
[
  {
    "tags": [
      "change",
